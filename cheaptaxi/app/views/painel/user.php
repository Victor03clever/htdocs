    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Formulario para adicionar usuario</h5>
            ...
            <div class="modal-body">
                <form action="<?=BASE_URL.'usuarios/adicionar'?>" method="post">
                    ...
                    <button type="submit" class="btn btn-success col-12">Adicionar usuario</button>
                </form>
            </div>
        </div>
    </div>
...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            <td scope="row"><?=$user['idUsuario']?></td>
            <td><?=$user['login']?></td>
            <td>
                <a href="#" class="btn btn-info">Editar</a>
                <a href="<?=BASE_URL.'usuarios/remover/'.$user['idUsuario']?>" class="btn btn-danger">Eliminar</a>
            </td>
        </tr>
        <?php endforeach; ?>
    </tbody>
