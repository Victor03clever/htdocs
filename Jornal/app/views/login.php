...
<head>
    ...
    <title>Jornal Online - Entrar</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Seja bem vindo administradora!</h1>
                                    </div>
                                    <form method="POST">
                                    	<?=getFlash("danger")?>
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                ...
                                                <label class="custom-control-label" for="customCheck">Lembrar-me neste dispositivo
                                                    Me</label>
                                            </div>
                                        </div>
